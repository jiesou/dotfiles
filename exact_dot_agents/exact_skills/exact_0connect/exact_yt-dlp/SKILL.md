---
name: yt-dlp
description: "Get any video transcripts, such as youtube, bilibili."
---
...
- **YouTube** — 附带评论，CC 自动字幕 / ASR fallback
- **Bilibili** — 附带评论，AI 中文字幕 / ASR fallback
- 所有 yt-dlp 支持的其他平台 — 不带评论，只通过 ASR 转录
