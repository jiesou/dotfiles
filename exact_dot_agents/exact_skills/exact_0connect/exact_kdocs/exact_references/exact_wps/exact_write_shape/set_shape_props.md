...
# wps.write_shape（action=set_shape_props）

#### 功能说明

设置几何属性

或 body 传 wrap_type/z_order 等
...
- `shape_prop_key` (string, 可选): 形状几何属性名，如 Width、Height、Rotation；默认值：`Width`
- `shape_prop_value` (number, 可选): 形状几何属性值，与 shape_prop_key 配对
