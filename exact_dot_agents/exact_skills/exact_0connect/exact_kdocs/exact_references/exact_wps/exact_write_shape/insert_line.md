...
# wps.write_shape（action=insert_line）
...
- `begin_x` (number, 必填): 线条起点 X（insert_line）
- `begin_y` (number, 必填): 线条起点 Y（insert_line）
- `end_x` (number, 必填): 线条终点 X（insert_line）
- `end_y` (number, 必填): 线条终点 Y（insert_line）
