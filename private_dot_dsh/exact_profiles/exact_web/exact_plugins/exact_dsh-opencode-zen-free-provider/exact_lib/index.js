...
const rewriteZenRefusalMessage = (errorMessage) => {
...
const zenApi = {
    stream: (model, context, options) => sanitizeZenStream(piAgentStream({ ...model, headers: zenApiHeaders(model, context, options) }, normalizeReasoningContext(model, context), options)),
    streamSimple: (model, context, options) => sanitizeZenStream(piAgentStreamSimple({ ...model, headers: zenApiHeaders(model, context, options) }, normalizeReasoningContext(model, context), options)),
};
